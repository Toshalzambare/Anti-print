      ...
      <header className="relative overflow-hidden pt-20 pb-32 px-6">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
             <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-2xl border border-slate-100 dark:border-slate-700 rotate-2 hover:rotate-0 transition-all duration-500">
                <div className="flex items-center justify-between mb-6 border-b border-slate-100 dark:border-slate-700 pb-4">
                   <div className="flex items-center gap-3">
                      ...
                      <div>
                         <p className="font-bold text-slate-800 dark:text-white">Rahul's Thesis.pdf</p>
                         <p className="text-xs text-slate-400">Ready for pickup • 45 Pages</p>
                      </div>
                   </div>
                   <span className="bg-green-100 text-green-700 px-3 py-1 rounded-full text-xs font-bold dark:bg-green-900 dark:text-green-300">READY</span>
                </div>
                ...
                <div className="mt-6 flex justify-between items-center">
                   <p className="font-bold text-xl dark:text-white">₹120.00</p>
